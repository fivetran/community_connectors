...
- **[ehi](https://github.com/fivetran/community_connectors/tree/main/ehi)** - This example shows how to sync EHI tables such as Caboodle using Connector SDK. It connects to Microsoft SQL server to sync the data. You need to provide your server credentials for this example to work.
- **[ehi_high_volume](https://github.com/fivetran/community_connectors/tree/main/ehi_high_volume)** - High-volume Microsoft SQL Server connector for syncing 100M+ row tables using keyset and offset pagination with parallel processing
