...
> For syncing data from a Magma bucket on Couchbase Capella, please refer to the [Couchbase Capella connector example](https://github.com/fivetran/community_connectors/tree/main/couchbase_capella).
